...
# avg.bid.by.period.ms <- subset(avg.bid.by.period, Period>24 & Period<28)
# 
# avg.bid.by.period.ms$Period <- as.character(avg.bid.by.period.ms$Period)
# avg.bid.by.period.ms$p25 <- ifelse(avg.bid.by.period.ms$Period == '25', 1, 0)
# avg.bid.by.period.ms$p26 <- ifelse(avg.bid.by.period.ms$Period == '26', 1, 0)
# avg.bid.by.period.ms$p27 <- ifelse(avg.bid.by.period.ms$Period == '27', 1, 0)
# 
# model <- lm(avg.Effort ~ p26 + p27, data=avg.bid.by.period.ms)
# summary(model)
```
